...
export const AuditAction = {
  ...
  // WhatsApp + Sinery Assist flow (Prompt 19)
  WHATSAPP_ASSIST_AUTO_TRIGGERED: "WHATSAPP_ASSIST_AUTO_TRIGGERED",
  WHATSAPP_ASSIST_MANUAL_TRIGGERED: "WHATSAPP_ASSIST_MANUAL_TRIGGERED",
  WHATSAPP_ASSIST_REPLY_GENERATED: "WHATSAPP_ASSIST_REPLY_GENERATED",
  WHATSAPP_ASSIST_REPLY_SENT: "WHATSAPP_ASSIST_REPLY_SENT",
  WHATSAPP_ASSIST_REPLY_INTERNAL_ONLY: "WHATSAPP_ASSIST_REPLY_INTERNAL_ONLY",
  WHATSAPP_ASSIST_REPLY_FAILED: "WHATSAPP_ASSIST_REPLY_FAILED",
  WHATSAPP_ASSIST_PROCESSING_SKIPPED: "WHATSAPP_ASSIST_PROCESSING_SKIPPED",
  WHATSAPP_ASSIST_PROCESSING_DUPLICATE_IGNORED: "WHATSAPP_ASSIST_PROCESSING_DUPLICATE_IGNORED",
  WHATSAPP_ASSIST_SKIPPED_HUMAN_HANDLING: "WHATSAPP_ASSIST_SKIPPED_HUMAN_HANDLING",
  WHATSAPP_ASSIST_SKIPPED_WAITING_HUMAN: "WHATSAPP_ASSIST_SKIPPED_WAITING_HUMAN",
  WHATSAPP_ASSIST_ENABLED_FOR_CONVERSATION: "WHATSAPP_ASSIST_ENABLED_FOR_CONVERSATION",
  WHATSAPP_ASSIST_DISABLED_FOR_CONVERSATION: "WHATSAPP_ASSIST_DISABLED_FOR_CONVERSATION",
  WHATSAPP_ASSIST_TRANSFERRED_TO_HUMAN: "WHATSAPP_ASSIST_TRANSFERRED_TO_HUMAN",

  // Evolution API messaging provider (Prompt 24 — HML/testing)
  EVOLUTION_WEBHOOK_RECEIVED: "EVOLUTION_WEBHOOK_RECEIVED",
  EVOLUTION_WEBHOOK_INVALID_SECRET: "EVOLUTION_WEBHOOK_INVALID_SECRET",
  EVOLUTION_WEBHOOK_EVENT_IGNORED: "EVOLUTION_WEBHOOK_EVENT_IGNORED",
  EVOLUTION_MESSAGE_RECEIVED: "EVOLUTION_MESSAGE_RECEIVED",
  EVOLUTION_MESSAGE_DUPLICATE_IGNORED: "EVOLUTION_MESSAGE_DUPLICATE_IGNORED",
  EVOLUTION_MESSAGE_SEND_REQUESTED: "EVOLUTION_MESSAGE_SEND_REQUESTED",
  EVOLUTION_MESSAGE_SENT: "EVOLUTION_MESSAGE_SENT",
  EVOLUTION_MESSAGE_SEND_FAILED: "EVOLUTION_MESSAGE_SEND_FAILED",
  EVOLUTION_MESSAGE_SEND_BLOCKED: "EVOLUTION_MESSAGE_SEND_BLOCKED",
  EVOLUTION_ASSIST_AUTO_TRIGGERED: "EVOLUTION_ASSIST_AUTO_TRIGGERED",
  EVOLUTION_ASSIST_REPLY_SENT: "EVOLUTION_ASSIST_REPLY_SENT",
  EVOLUTION_ASSIST_REPLY_FAILED: "EVOLUTION_ASSIST_REPLY_FAILED",
...
export const auditActionLabels: Record<string, string> = {
  ...
  WHATSAPP_ASSIST_AUTO_TRIGGERED: "Assist acionada automaticamente (WhatsApp)",
  WHATSAPP_ASSIST_MANUAL_TRIGGERED: "Assist acionada manualmente (WhatsApp)",
  WHATSAPP_ASSIST_REPLY_GENERATED: "Resposta da Assist gerada (WhatsApp)",
  WHATSAPP_ASSIST_REPLY_SENT: "Resposta da Assist enviada (WhatsApp)",
  WHATSAPP_ASSIST_REPLY_INTERNAL_ONLY: "Resposta da Assist apenas interna (WhatsApp)",
  WHATSAPP_ASSIST_REPLY_FAILED: "Falha ao enviar resposta da Assist (WhatsApp)",
  WHATSAPP_ASSIST_PROCESSING_SKIPPED: "Processamento da Assist ignorado (WhatsApp)",
  WHATSAPP_ASSIST_PROCESSING_DUPLICATE_IGNORED: "Processamento da Assist duplicado ignorado",
  WHATSAPP_ASSIST_SKIPPED_HUMAN_HANDLING: "Assist ignorada — atendimento humano",
  WHATSAPP_ASSIST_SKIPPED_WAITING_HUMAN: "Assist ignorada — aguardando humano",
  WHATSAPP_ASSIST_ENABLED_FOR_CONVERSATION: "Assist reativada para a conversa (WhatsApp)",
  WHATSAPP_ASSIST_DISABLED_FOR_CONVERSATION: "Assist desativada para a conversa (WhatsApp)",
  WHATSAPP_ASSIST_TRANSFERRED_TO_HUMAN: "Assist transferiu para humano (WhatsApp)",
  EVOLUTION_WEBHOOK_RECEIVED: "Webhook Evolution recebido",
  EVOLUTION_WEBHOOK_INVALID_SECRET: "Segredo do webhook Evolution inválido",
  EVOLUTION_WEBHOOK_EVENT_IGNORED: "Evento do webhook Evolution ignorado",
  EVOLUTION_MESSAGE_RECEIVED: "Mensagem recebida via Evolution",
  EVOLUTION_MESSAGE_DUPLICATE_IGNORED: "Mensagem Evolution duplicada ignorada",
  EVOLUTION_MESSAGE_SEND_REQUESTED: "Envio via Evolution solicitado",
  EVOLUTION_MESSAGE_SENT: "Mensagem Evolution enviada",
  EVOLUTION_MESSAGE_SEND_FAILED: "Falha ao enviar mensagem Evolution",
  EVOLUTION_MESSAGE_SEND_BLOCKED: "Envio Evolution bloqueado",
  EVOLUTION_ASSIST_AUTO_TRIGGERED: "Assist acionada automaticamente (Evolution)",
  EVOLUTION_ASSIST_REPLY_SENT: "Resposta da Assist enviada (Evolution)",
...
export function getAuditActionTone(action: string): "danger" | "warning" | "success" | "info" {
  if (
    ...
    action === "WHATSAPP_ASSIST_REPLY_FAILED" ||
  ...
  if (
    ...
    action === "WHATSAPP_ASSIST_PROCESSING_SKIPPED" ||
    action === "WHATSAPP_ASSIST_PROCESSING_DUPLICATE_IGNORED" ||
    action === "WHATSAPP_ASSIST_SKIPPED_HUMAN_HANDLING" ||
    action === "WHATSAPP_ASSIST_SKIPPED_WAITING_HUMAN" ||
    action === "WHATSAPP_ASSIST_TRANSFERRED_TO_HUMAN" ||
  ...
  if (
    ...
    action === "WHATSAPP_ASSIST_REPLY_SENT" ||
    action === "WHATSAPP_ASSIST_ENABLED_FOR_CONVERSATION"
  ) {
    return "success"
  }
  return "info"
